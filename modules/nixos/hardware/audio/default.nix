...
in {
  options.caramelmint.hardware.audio = with types; {
  ...
  config = mkIf cfg.enable {
    ...
    # Commented out this manual config file as it was causing pipewire to crash on startup as it tries to write to this conf file for some reason.
    # environment.etc = {
    ...
    caramelmint.user.extraGroups = ["audio"];
